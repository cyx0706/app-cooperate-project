...
function FloatingCaptcha(img_url) {
    this.url = img_url;
    ...
    function createCanvas() {
      this.puzzle_shadow = document.createElement('canvas');
      this.puzzle_shadow.id = "puzzleShadow";
      this.puzzle_lost = document.createElement('canvas');
      this.puzzle_lost.id = "puzzleLost";
      this.puzzle_box = document.createElement('canvas');
      this.puzzle_box.id = "puzzleBox";
      this.div1.appendChild(puzzle_box, puzzle_shadow, puzzle_lost);
    }
    ...
    function fillImg() {
      ...
      img.onload = function () {
        alert("加载完毕");
        this.puzzle_box.drawImage(img, 0 ,0);
      };
      img.src = this.url;
    }
